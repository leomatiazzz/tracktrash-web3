...
export declare namespace EcoBadge {
      
    export type BadgeDataStruct = {achievementType: string, impactScore: BigNumberish, issuedAt: BigNumberish}

    export type BadgeDataStructOutput = [achievementType: string, impactScore: bigint, issuedAt: bigint] & {achievementType: string, impactScore: bigint, issuedAt: bigint }
  
    }

  export interface EcoBadgeInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "MINTER_ROLE" | "approve" | "balanceOf" | "getApproved" | "getBadgeData" | "getRoleAdmin" | "grantRole" | "hasRole" | "isApprovedForAll" | "mintBadge" | "name" | "nextTokenId" | "ownerOf" | "renounceRole" | "revokeRole" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "BadgeMinted" | "BatchMetadataUpdate" | "MetadataUpdate" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "Transfer"): EventFragment;
...
encodeFunctionData(functionFragment: 'getBadgeData', values: [BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'getBadgeData', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
    ...
    export namespace BadgeMintedEvent {
      export type InputTuple = [recipient: AddressLike, tokenId: BigNumberish, achievementType: string, impactScore: BigNumberish, metadataURI: string];
      export type OutputTuple = [recipient: string, tokenId: bigint, achievementType: string, impactScore: bigint, metadataURI: string];
      export interface OutputObject {recipient: string, tokenId: bigint, achievementType: string, impactScore: bigint, metadataURI: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface EcoBadge extends BaseContract {
    
    connect(runner?: ContractRunner | null): EcoBadge;
    waitForDeployment(): Promise<this>;

    interface: EcoBadgeInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getBadgeData: TypedContractMethod<
      [tokenId: BigNumberish, ],
      [EcoBadge.BadgeDataStructOutput],
      'view'
    >
...
getFunction(nameOrSignature: 'getApproved'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getBadgeData'): TypedContractMethod<
      [tokenId: BigNumberish, ],
      [EcoBadge.BadgeDataStructOutput],
      'view'
    >;
...
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'BadgeMinted(address,uint256,string,uint256,string)': TypedContractEvent<BadgeMintedEvent.InputTuple, BadgeMintedEvent.OutputTuple, BadgeMintedEvent.OutputObject>;
